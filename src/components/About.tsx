  ...
  return (
    ...
    4/9
      ...
      <ul>
        ...
        <li>SEARCHのタグ検索に使っているcheckboxが、ダブルタップしないと表示がつかない。原因はFromタグにあるようだが、
          対処法がわからないので外部ライブラリに頼ろうと思う。
        </li>
        <li>無限スクロールではリアルっぽさを出すためにsetTimeoutを使った。Firebaseを導入したらここはasyncに変更する。</li>
        <li>Stateの変更タイミングがいまいち分からなかったので、SEARCHの無限スクロールは少し苦労した。
          <br />
